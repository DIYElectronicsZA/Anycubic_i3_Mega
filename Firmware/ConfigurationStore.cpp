...
void OutageRead()
{
    ...
    SERIAL_ECHOPAIR(" x",last_position[3]);
    SERIAL_ECHOPAIR(" y",last_position[2]);
    SERIAL_ECHOPAIR(" z",last_position[1]);
    SERIAL_ECHOPAIR(" e",last_position[0]);
}
...
{  // Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
    ...
    SERIAL_ECHOLN("");
    SERIAL_ECHOLNPGM("lost pos:");  
    SERIAL_ECHO_START;
    SERIAL_ECHOPAIR(" X",last_position[0]);
    SERIAL_ECHOPAIR(" Y",last_position[1]);
    SERIAL_ECHOPAIR(" Z",last_position[2]);
    SERIAL_ECHOPAIR(" E",last_position[3]);
    SERIAL_ECHOLN("");
